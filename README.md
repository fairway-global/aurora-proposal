...
| [7. Milestones and Success Criteria](docs/07-milestones-and-success-criteria.md) | Four milestones, outputs, criteria, and expenditure principles |
| [8. Risks and Mitigation](docs/08-risks-and-mitigation.md) | Delivery, interoperability, adoption, verification, governance, and operating risks |
| [9. Governance and Oversight](docs/09-governance-and-oversight.md) | Independent multisignature custody, milestone oversight, reporting, and refunds |
| [10. Conclusion](docs/10-conclusion.md) | Lasting value of the open infrastructure |
| [11. Governance Submission Requirements](docs/11-governance-submission-requirements.md) | Canonical reference, recipient, Net Change Limit, audit, ADA treatment, and conflicts |
| [Appendix A](docs/appendix-a-verification-framework.md) | Verification Framework principles and participant responsibilities |
